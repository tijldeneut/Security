...
r''' 
        ...
        ## INFO:
        # CVE-2025-49704/53770 (RCE) & CVE-2025-49706 (Spoofing), Unauthenticated RCE
...
def isVulnerable(version):
    ...
    if buildnr[0] == '15': ## 2013, 2016 or 2019
        if buildnr[1] == '2':
            ...
            if sResult[0] and sResult[1] == 'vuln': print('[!] Unpatched {}: vulnerable to CVE-2025-49704/49706/53770 (Unauthenticated RCE, actively exploited)'.format(sResult[0]))
            elif not sResult[0] and sResult[1] == 'vuln': print('[!] Vulnerable to CVE-2025-49704/49706/53770 (Unauthenticated RCE, actively exploited)')
